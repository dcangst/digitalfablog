...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('purpose', models.PositiveSmallIntegerField(choices=[(0, 'Fablog'), (1, 'Donation'), (2, 'Store'), (3, 'Expenses'), (4, 'Correction'), (5, 'Membership'), (6, 'CashCount')], default=0, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cashier_date', models.DateField(default=django.utils.timezone.now, help_text='Cash count date', verbose_name='cash count date')),
                ('total', models.DecimalField(decimal_places=2, help_text='total cash', max_digits=20, verbose_name='total cash')),
                ('booking', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='cashier.Booking')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.PositiveSmallIntegerField(choices=[(0, 'Coin'), (1, 'Banknote')], default=0)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('balance_expected', models.DecimalField(decimal_places=2, help_text='Balance expected', max_digits=20, verbose_name='Balance expected')),
                ('balance_true', models.DecimalField(blank=True, decimal_places=2, help_text='Balance true', max_digits=20, null=True, verbose_name='Balance true')),
