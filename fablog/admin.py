...
from .models import Fablog, MachinesUsed, FablogMemberships, FablogPayments, FablogBookings, FabDay
...
class FablogAdmin(admin.ModelAdmin):
    inlines = (MachinesUsedInline, FablogMembershipsInline, FablogBookingsInline, FablogPaymentsInline)
    readonly_fields = ("total_machines", "total_memberships", "total")
